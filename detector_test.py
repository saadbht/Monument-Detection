...
class Detector():
            ...
            for i, det in enumerate(pred):  # detections per image
                ...
                if save_img:
                    if dataset.mode == 'images':
                        ...
                        # Save into the configured output folder.
                        im.save(str(Path(out) / "output.jpg"))
    ...
    def detect_action(self):
        ...
        bgr_image = cv2.imread(str(output_dir / "output.jpg"))
        # Write the final image (used for the web UI preview) into the same output folder.
        cv2.imwrite(str(output_dir / "color_img.jpg"), bgr_image)
        opencodedbase64 = self.encodeImageIntoBase64(str(output_dir / "color_img.jpg"))
